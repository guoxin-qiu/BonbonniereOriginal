...
namespace Bonbonniere.IntegrationTests
{
    ...
    {
        private const string SolutionName = "Bonbonniere.sln";
        ...
        private static string GetProjectPath(string solutionRelativePath, Assembly startupAssembly)
        {
            ...
            // Find the folder which contains the solution file. We then use this information to find the target project which we want to test.
